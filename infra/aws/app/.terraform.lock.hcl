# ABOUTME: Pins provider versions for the AWS API stack so tofu apply is reproducible.
# ABOUTME: Auto-generated lockfile consumed by OpenTofu when running in infra/aws/app.
